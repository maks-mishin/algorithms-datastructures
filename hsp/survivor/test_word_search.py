...
from tasks.word_search import WordSearch


class TestWordSearch(unittest.TestCase):
    def test_word_search(self):
        result = WordSearch(12, "1) stroka razbivaetsya na nabor strok "
                                "cherez vyravnivanie po zadannoj shirine.",
                            "strok")
        self.assertEqual(result, [0, 0, 0, 1, 0, 0, 0])

        result_1 = WordSearch(12, "строка разбивается на набор строк через "
                                  "выравнивание по заданной ширине.", "строк")
